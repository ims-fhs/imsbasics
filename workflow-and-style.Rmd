...
Therefore getting fluent with git on the console is very useful.. (eventhough it might look like wasting your time in the first place. I (Adrian) didn't believe Christoph in the first place and had to learn it on the hard tour..)
...
### Git: Set up the editor of your choice ...SCN: Delete?
...
* `branch` Note: A branch in Git is simply a 
...
commit you made. Every time you commit, it moves forward automatically.
    ...
    `git config branch.localbranch.merge refs/heads/localbranch` This is very useful to be sure the upstream references are right before you push or pull! Because `git branch -u remoteserver/branch localbranch` doesn't mess up nothing..
...
## Case 8: You want to start work on a package based on your own "work in progress (wip)" branch => SCN: Delete? Case 1 deckt Case 8 ab.
...
## Case 9: Undo a commit and redo => SCN: Delete?
