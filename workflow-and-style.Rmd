...
repository remotename (Normally called origin) in remotebranch. If remotebranch does 
not exist, it is automatically created. If only one branch is specified, it is 
assumed that localbranch = remotebranch.  
