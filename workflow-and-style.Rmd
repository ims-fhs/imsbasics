...
Packages: `mngflabrr` Trade of between: googleable, remindable, selfexplainable, short etc. [link](http://r-pkgs.had.co.nz/package.html#package-structure)
...
## Documentation
1. R packages are documented with vignette(s). <http://r-pkgs.had.co.nz/vignettes.html#vignette-workflow>
2. Every project has a starUML document describing the software architecture of the project according to the [4+1 view model](https://en.wikipedia.org/wiki/4%2B1_architectural_view_model).
...
On Mac OSX use path:  #!/Library/Frameworks/R.framework/Versions/3.2/Resources/bin/Rscript
