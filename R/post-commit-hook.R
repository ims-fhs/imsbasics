...
#
# In instances where you do NOT want the version incremented, add the environment variable inc=FALSE to your git
# call. eg "inc=FALSE git commit -m "commit message"".
...
if (inc){
  ...
  system('inc=FALSE git commit -m "increment package version"') # inc=FALSE is required, otherwise we end up in an infinite loop
