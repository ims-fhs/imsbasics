...
blob objects, or changes between two files on disk.
    ...
    View the differences going from the remote file to the local file.
    - `diff HEAD:local/path/file1.txt remotename/branchname:remote/path/file1.txt`:
    View the differences in the other direction
...
=> Diff. Select the file you want to commit. The lower part of the editor shows your changes:
